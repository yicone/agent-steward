...
Define the accepted behavior for the bounded repo-local project evidence
provider that discovers explicit agent-facing project evidence and normalizes it
for governance surfaces.
