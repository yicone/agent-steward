...
This document defines the canonical terminology for `agent-storage-manager` as the product evolves from a session-first browser into a project-first agent context cockpit.
