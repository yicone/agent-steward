...
- [x] **Step 4: Commit the pure contract**
...
- [x] **Step 2: Implement the route option**
...
- [x] **Step 1: Add UI tests for the privacy contract**
...
- [x] **Step 2: Implement local UI state**
...
- [x] **Step 3: Apply redaction only to copy actions**
...
- [x] **Step 4: Run UI and full validation**
...
- [x] **Step 1: Document the explicit privacy behavior**
...
- [x] **Step 2: Run final validation and local review**
