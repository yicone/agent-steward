...
describe("BackupMigrationFoundation panels", () => {
  ...
  it("renders project bundle global blockers without assigning them to member inventory", () => {
          ...
          items: [
            {
              ...
              severity: "block",
              detail: "Project bundle output root is unavailable or not writable. Fix permissions for the configured output root, or set AGENT_STEWARD_PROJECT_BUNDLE_ROOT to a writable local directory, then retry.",
            },
          ],
        }}
      />
    ...
    expect(html).toContain("AGENT_STEWARD_PROJECT_BUNDLE_ROOT");
